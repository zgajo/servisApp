...
$query = $conn->getConnection()->prepare("SELECT stranka_id, ime, prezime, tvrtka, adresa, grad FROM stranka WHERE ime LIKE  CONCAT(?,'%') OR prezime LIKE  CONCAT(?,'%') OR tvrtka LIKE  CONCAT(?,'%')");
