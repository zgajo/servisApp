                                ...
                                <div class="box-body box-profile">
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        <li class="list-group-item">
                                            <b>Adresa</b>
                                            <a id="adresa" class="pull-right"></a>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Grad</b>
                                            <a id="grad" class="pull-right"></a>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Kontakt broj</b>
                                            <a id="kontakt" class="pull-right"></a>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Email</b>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function podaciKupca(kid) {
                        $.get("json/kupac/primkaByKupac.php", {
                            "id": kid
                        }, function (kupac) {
                            console.log(kupac);
                ...
                $("#sve_primke").on("click", "tbody tr", function () {
                    console.log($(this).find( 'td:first-child a').attr('name'));
                    window.location  = "pregled.php?primka=" + $(this).find( 'td:first-child a').attr('name');
                })
