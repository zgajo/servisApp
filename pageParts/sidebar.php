...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if ($_COOKIE['odjel'] == "Servis" || $_COOKIE['odjel'] == "Reklamacije" ) { ?><li class="<?php echo ($_SERVER['PHP_SELF'] == "/servis/rn.php" ? "active" : "") ?>"><a href="./rn.php"><i class="glyphicon glyphicon-share"></i> <span>Radni nalozi</span></a></li><?php } ?>
