...
$('#sviRN_zavrseni tbody').on("mouseover", "tr", function () {
    $(this).css('background-color', '#ccffcc');
    $(this).find('#uredi_rn').show();
    var brdana  = $(this).find('#broj_dana').text();
    $(this).attr('title', 'Broj dana od zaprimanja: '+brdana+'. Kliknite za više opcija ');
});
$('#sviRN_zavrseni tbody').on("mouseout", "tr", function () {
    $(this).removeAttr('style');
    $(this).find('#uredi_rn').hide();
});
...
$.ajax({
    async: false,
    url: "json/rn/sviRNservisOtvoreni.php",
    type: 'POST',
    dataType: 'json',
...
$.ajax({
    async: false,
    url: "json/rn/sviRNservisZavrseni.php",
    type: 'POST',
    dataType: 'json',
    contentType: "application/json; charset=utf-8",
    success: function (rn) {
...
$('#sviRN_zavrseni').on("mouseover", "#uredi_rn", function () {
    $(this).attr("title", "Uredi radni nalog");
})

$('#sviRN_zavrseni').on("mouseover", " tbody tr td:first-child", function () {
    $(this).attr("title", "Uredi radni nalog");
})
$('#sviRN_zavrseni').on("mouseover", " tbody tr td:nth-child(2)", function () {
    $(this).attr("title", "Uredi radni nalog");
})
$('#sviRN_zavrseni').on("click", " tbody tr td:first-child", function () {
    window.location = "rn.php?radni_nalog=" + $(this).find('a').attr("name");
})
$('#sviRN_zavrseni').on("click", " tbody tr td:nth-child(2)", function () {
    window.location = "rn.php?radni_nalog=" + $(this).find('a').attr("name");
})