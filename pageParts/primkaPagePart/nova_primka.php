...
$td = new djelatnik();
$td = $td->getDjelatnikById($_COOKIE['id']);
?>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="tvrtka" class="form-control" id="inputTvrtka" placeholder="" type="text" value="<?php echo $osoba['tvrtka'] ?>" disabled="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                                ...
                                <input type="date" id="inputDK" name="dk" class="form-control" data-inputmask="'alias': 'dd.mm.yyyy'" data-mask >
                    </div><!-- /.input group -->
...
<?php unset($stranka); unset($osoba); } else{ ?>
